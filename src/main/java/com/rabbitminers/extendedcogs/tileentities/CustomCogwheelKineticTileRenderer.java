...
public class CustomCogwheelKineticTileRenderer extends BracketedKineticTileRenderer {
	public CustomCogwheelKineticTileRenderer(BlockEntityRendererProvider.Context context) {
		super(context);
	}
